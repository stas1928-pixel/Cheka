...
js/repertoire.data.js   GENERATED by tools/build-repertoire.mjs — never hand-edit
...
tools/build-repertoire.mjs   grow the whole line tree from a Chess.com user's games + engine
